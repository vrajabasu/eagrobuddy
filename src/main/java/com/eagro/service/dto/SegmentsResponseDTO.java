...
public class SegmentsResponseDTO   {
  ...
  public enum OverallThresholdstateEnum {
    ABOVE_REF_RANGE("ABOVE_REF_RANGE"),
    
    BELOW_REF_RANGE("BELOW_REF_RANGE"),
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(segmentId, segmentName, segmentDescription, activeFlag, startX, startY, endX, endY, overallThresholdstate);
  }
