...
public class Layout implements Serializable {
    ...
    @ManyToMany
    @JoinTable(name = "layout_user_layout_mapping",
               joinColumns = @JoinColumn(name="layout_id", nullable = false),
               inverseJoinColumns = @JoinColumn(name="user_layout_mappings_id", referencedColumnName="id"))
    ...
    public Layout userLayoutMappings(Set<UserLayoutMapping> userLayoutMappings) {
        this.userLayoutMappings = userLayoutMappings;
        return this;
    }

    public Layout addUserLayoutMapping(UserLayoutMapping userLayoutMapping) {
        this.userLayoutMappings.add(userLayoutMapping);
        userLayoutMapping.getLayouts().add(this);
        return this;
    }

    public Layout removeUserLayoutMapping(UserLayoutMapping userLayoutMapping) {
        this.userLayoutMappings.remove(userLayoutMapping);
        userLayoutMapping.getLayouts().remove(this);
        return this;
    }
